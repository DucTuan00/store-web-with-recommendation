...
public class Datainit implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        // user1.setFavoriteCategories("Electronics,Books");

        // User user2 = new User();
        // user2.setUsername("user2");
        // user2.setPassword("password2");
        // user2.setFavoriteCategories("Movies,Music");

        // User user3 = new User();
        // user3.setUsername("user3");
        // user3.setPassword("password3");
        // user3.setFavoriteCategories("Clothing,Books");

        // User user4 = new User();
        // user4.setUsername("user4");
        // user4.setPassword("password4");
        // user4.setFavoriteCategories("Electronics,Movies");

        // User user5 = new User();
        // user5.setUsername("user5");
        // user5.setPassword("password5");
        // user5.setFavoriteCategories("Music,Clothing");
        ...
        // userOrderRepository.saveAll(List.of(order1, order2, order3, order4, order5, order6, order7, order8, order9, order10));
    }
}
